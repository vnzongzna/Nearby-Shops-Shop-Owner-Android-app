...
public interface UserService {
    ...
    @PUT ("/api/v1/User/UpdateProfileShopAdmin")
    Call<ResponseBody> updateProfileShopAdmin(@Header("Authorization") String headers,
                                              @Body User user);
    ...
    @POST ("/api/v1/User/SignUp/ShopAdminRegistration")
    Call<User> shopAdminRegistration(@Body User user);
    ...
    @POST("/api/v1/User/SignUp/DeliveryGuySelfRegistration")
    Call<User> deliveryGuySelfRegistration(
    ...
    @POST ("/api/v1/User/SignUp/ShopStaffRegistration")
    Call<User> ShopStaffRegistration(@Header("Authorization") String headers,
                                     @Body User user);
