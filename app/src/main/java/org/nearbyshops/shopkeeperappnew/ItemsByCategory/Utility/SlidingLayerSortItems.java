package org.nearbyshops.shopkeeperappnew.ItemsByCategory.Utility;
...
import org.nearbyshops.shopkeeperappnew.ItemsByCategory.PrefSortItems;
...
//        String[] sort_options = UtilitySortShops.getSort(getActivity());
        ...
        currentSort = PrefSortItems.getSort(getActivity());
        currentAscending = PrefSortItems.getAscending(getActivity());
    ...
    void sortByNameClick(View view)
    {
        ...
        PrefSortItems.saveSort(getActivity(),SORT_BY_ITEM_RATING);
    ...
    void sortByCreated(View view)
    {
        ...
        PrefSortItems.saveSort(getActivity(),SORT_BY_POPULARITY);
    ...
    void sortByShopCount(View view)
    {
        ...
        PrefSortItems.saveSort(getActivity(),SORT_BY_SHOP_COUNT);
    ...
    void sortByPriceAvg(View view)
    {
        ...
        PrefSortItems.saveSort(getActivity(),SORT_BY_AVG_PRICE);
    ...
    void ascendingClick(View view)
    {
        ...
        PrefSortItems.saveAscending(getActivity(),SORT_ASCENDING);
    ...
    void descendingClick(View view)
    {
        ...
        PrefSortItems.saveAscending(getActivity(),SORT_DESCENDING);
