...
//        String[] sort_options = UtilitySortShops.getSort(getActivity());
    ...
    void sortByNameClick(View view)
    {
        ...
        PrefSortItemsInShop.saveSort(getActivity(), SORT_BY_ITEM_AVAILABLE);
    ...
    void sortByCreated(View view)
    {
        ...
        PrefSortItemsInShop.saveSort(getActivity(), SORT_BY_ITEM_PRICE);
    ...
    void sortByShopCount(View view)
    {
        ...
        PrefSortItemsInShop.saveSort(getActivity(), SORT_BY_DATE_ADDED);
    ...
    void sortByPriceAvg(View view)
    {
        ...
        PrefSortItemsInShop.saveSort(getActivity(), SORT_BY_DATE_UPDATED);
