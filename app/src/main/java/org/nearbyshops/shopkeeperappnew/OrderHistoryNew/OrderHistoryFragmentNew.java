package org.nearbyshops.shopkeeperappnew.OrderHistoryNew;
...
public class OrderHistoryFragmentNew extends Fragment implements SwipeRefreshLayout.OnRefreshListener, NotifySort, NotifySearch, ViewHolderOrder.ListItemClick {
    ...
    public OrderHistoryFragmentNew() {
    ...
    public static OrderHistoryFragmentNew newInstance() {
        OrderHistoryFragmentNew fragment = new OrderHistoryFragmentNew();
