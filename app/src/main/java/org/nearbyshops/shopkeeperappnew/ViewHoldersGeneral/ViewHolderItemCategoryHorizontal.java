...
public class ViewHolderItemCategoryHorizontal extends RecyclerView.ViewHolder{
    ...
    public static ViewHolderItemCategoryHorizontal create(ViewGroup parent, Context context, Fragment fragment,
                                                          RecyclerView.Adapter adapter)
    {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_item_category_small,parent,false);
        return new ViewHolderItemCategoryHorizontal(view,context,fragment,adapter);
    }
    ...
    public ViewHolderItemCategoryHorizontal(View itemView, Context context, Fragment fragment, RecyclerView.Adapter adapter
    )
    {
        super(itemView);
